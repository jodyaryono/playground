    ...
    <div class="col-sm-8 text-left"> 
      <h1>Halaman Kategori</h1>
         ...
         foreach($kategori->result_array() as $i):
          ...
          $kategori=$i['kategori'];
          ?>
         <form action="<?php echo base_url(); ?>kategori/simpan_ubah" method="post">
          <div class="form-group">
            <label for="kategori">Kategori</label>
            <input type="hidden" class="form-control" name="id_kategori" required="" value="<?php echo $id_kategori;?>">
            <input type="text" class="form_control" name="kategori" required="" value="<?php echo $kategori;?>">
          </div>
